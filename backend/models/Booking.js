...
const bookingSchema = new mongoose.Schema(
  {
    ...
    totalAmount: { type: Number, default: 0 },      // customer pays this
    driverAmount: { type: Number, default: 0 },     // driver earns this
    platformAmount: { type: Number, default: 0 },   // admin keeps this
    from: String,
    to: String,
  },
  { timestamps: true }
